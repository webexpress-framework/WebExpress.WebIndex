...
namespace WebExpress.WebIndex.Wql.Condition
{
        ...
        where TIndexItem : IIndexItem
    {
        ...
        public override IQuery<TIndexItem> Apply(IQuery<TIndexItem> query)
        {
            ...
            var greaterThanOrEqual = Expression.GreaterThanOrEqual(convertedProperty, valueExpression);

            var lambda = Expression.Lambda<Func<TIndexItem, bool>>(greaterThanOrEqual, param);
