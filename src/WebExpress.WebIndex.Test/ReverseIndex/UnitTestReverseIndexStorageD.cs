...
namespace WebExpress.WebIndex.Test.ReverseIndex
{
    ...
    public class UnitTestReverseIndexStorageD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output) : UnitTestReverseIndex<UnitTestIndexFixtureIndexD>(fixture, output)
    {
        /// <summary>
        /// Returns the field.
        /// </summary>
        ...
        {
            Name = "FirstName",
            PropertyInfo = typeof(UnitTestIndexTestDocumentD).GetProperty("FirstName"),
            Type = typeof(UnitTestIndexTestDocumentD)
        };
        ...
        public void Create()
        {
            ...
            // act
            var reverseIndex = new IndexStorageReverseTerm<UnitTestIndexTestDocumentD>(Context, Field, CultureInfo.GetCultureInfo("en"));
        ...
        public void Remove()
        {
            ...
            var before = reverseIndex.Retrieve(randomItem.FirstName, new IndexRetrieveOptions()).ToList();
            Assert.NotEmpty(before);

            // act
            reverseIndex.Delete(randomItem);

            var after = reverseIndex.Retrieve(randomItem.FirstName, new IndexRetrieveOptions()).ToList();
        ...
        public void Retrieve()
        {
            ...
            // act
            var items = reverseIndex.Retrieve(randomItem.FirstName, new IndexRetrieveOptions());
