...
namespace WebExpress.WebIndex.Test.WQL
{
    ...
    public class UnitTestWqlWordSearchD(UnitTestIndexFixtureWqlD fixture, ITestOutputHelper output) : IClassFixture<UnitTestIndexFixtureWqlD>
    {
        ...
        public void SingleWordQuery()
        {
            ...
            Assert.Equal("FirstName ~ 'Olivia'", wql.ToString()); // check the string representation of the WQL query
            Assert.Contains("Olivia", item.FirstName); // ensure the matched item contains "Helena" in its text
