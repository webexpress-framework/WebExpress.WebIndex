...
namespace WebExpress.WebIndex.Test.DocumentStore
{
    ...
    public class UnitTestDocumentStoreMemoryE : UnitTestDocumentStore<UnitTestIndexFixtureIndexE>
    {
        /// <summary>
        ...
        public UnitTestDocumentStoreMemoryE(UnitTestIndexFixtureIndexE fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Create()
        {
            ...
            // test execution
            var documentStore = new IndexMemoryDocumentStore<UnitTestIndexTestDocumentE>(context, (uint)Fixture.TestData.Count);
