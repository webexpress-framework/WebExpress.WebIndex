...
namespace WebExpress.WebIndex.Test.DocumentStore
{
    ...
    public class UnitTestDocumentStoreStorageB : UnitTestDocumentStore<UnitTestIndexFixtureIndexB>
    {
        /// <summary>
        ...
        public UnitTestDocumentStoreStorageB(UnitTestIndexFixtureIndexB fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Create()
        {
            ...
            // test execution
            var documentStore = new IndexStorageDocumentStore<UnitTestIndexTestDocumentB>(Context, (uint)Fixture.TestData.Count);
