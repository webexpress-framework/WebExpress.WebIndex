...
namespace WebExpress.WebIndex.Test.DocumentStore
{
    ...
    public class UnitTestDocumentStoreStorageD : UnitTestDocumentStore<UnitTestIndexFixtureIndexD>
    {
        /// <summary>
        ...
        public UnitTestDocumentStoreStorageD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Create()
        {
            ...
            // act
            var documentStore = new IndexStorageDocumentStore<UnitTestIndexTestDocumentD>(Context, (uint)Fixture.TestData.Count);
