...
namespace WebExpress.WebIndex.Test.DocumentStore
{
    ...
    public class UnitTestDocumentStoreMemoryC : UnitTestDocumentStore<UnitTestIndexFixtureIndexC>
    {
        /// <summary>
        ...
        public UnitTestDocumentStoreMemoryC(UnitTestIndexFixtureIndexC fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
